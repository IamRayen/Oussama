        ...
        <div className="contact-wrapper">
            <div className="contact container-fluid" >
                <div className="contact-information container d-flex flex-column flex-wrap">
                    ...
                    <a  href="mailto:voltaconsulting21@gmail.com" className="text-decoration-none h2 email ms-3 ms-md-5"><i className="bi bi-envelope-fill"></i> voltaconsulting21@gmail.com <span> <i class="bi bi-arrow-left"></i> Cliquez ici</span></a>
