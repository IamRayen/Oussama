  ...
  return (
       <div className="footer-basic border-top mt-5 container-xl">
        <footer>
            ...
            <p className="copyright">Website made by <a className='link00' style={{textDecoration:"none",fontWeight:"bold",color:"black"}} rel="noopener noreferrer" target="_blank" href='https://www.linkedin.com/in/rayenlabidi-full-stack-javascript-developer'>Rayen Labidi <i className="bi bi-box-arrow-up-right"></i></a></p>
        </footer>
    </div>
  )
};
